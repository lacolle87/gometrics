...
```bash
go install github.com/lacolle87/gometrics@v0.3.8
```
...
- Updated the installation section to use `go install github.com/lacolle87/gometrics@v0.3.8` to directly install the package from GitHub.