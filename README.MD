...
```bash
go install github.com/lacolle87/gometrics@latest
```
...
- Updated the installation section to use `go install github.com/lacolle87/gometrics@latest` to directly install the package from GitHub.